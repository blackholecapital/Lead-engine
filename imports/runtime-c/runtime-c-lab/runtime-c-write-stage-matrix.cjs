...
const root=process.argv[2] || "/opt/eila-os/factory-xyz/runtime-c/tools/runtime-c-lab";
const stages=[
...
"|---|---|---|",
...stages.map(r=>`| ${r[0]} | ${r[1]} | ${r[2]} |`),
"",
"FINAL_STATUS=PASS"
].join("\n");
fs.writeFileSync(path.join(root,"RUNTIME_C_STAGE_MATRIX.md"),md+"\n");
console.log("PASS runtime-c-write-stage-matrix");
